    ...
    public partial class newmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublishedCourses", x => new { x.CourseID, x.DomainID });
                    table.ForeignKey(
                        name: "FK_PublishedCourses_Course_CourseID",
                        column: x => x.CourseID,
                        principalTable: "Course",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublishedCourses_Domain_DomainID",
                        column: x => x.DomainID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublishedCourses_DomainID",
                table: "PublishedCourses",
                column: "DomainID");
        }
